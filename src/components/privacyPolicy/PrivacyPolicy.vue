<template>
  <v-card>
    ...
    <v-card-text>
      <p>
        Sriharsha Samana built the Just Restart app as a Free app. This SERVICE
        is provided by Sriharsha Samana at no cost and is intended for use as
        ...
        Conditions, which is accessible at Just Restart unless otherwise defined
      ...
      <p>
        ...
        identifiable information, including but not limited to Basic information
        like Full name, Profile picture, Email address, Phone number and current
        device location. The app does use third party services that may collect
        information used to identify you. Link to privacy policy of third party
        service providers used by the app Firebase Analytics Firebase
        Crashlytics Facebook Log Data
      </p>
      <p>
        ...
        other statistics. Cookies Cookies are files with a small amount of data
        that are commonly used as anonymous unique identifiers. These are sent
        to your browser from the websites that you visit and are stored on your
      ...
      <p>
        ...
        <a href="mailto:sriharsha.samana@gmail.com"
          >sriharsha.samana@gmail.com</a
        >.
      </p>
    </v-card-text>
